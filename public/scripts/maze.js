function generateSquareMaze(dimension, rng) {
    if (!rng || typeof rng.random !== 'function') {
        throw new Error('generateSquareMaze requires a seeded rng');
    }
    ...
    function iterate(field, x, y) {
        ...
        while (true) {
            ...
            var dir = directions[Math.floor(rng.random() * directions.length)];
